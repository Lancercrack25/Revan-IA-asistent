...
def escanear_archivo_python(ruta_archivo: str) -> tuple[int, int]:
    """
    Analiza la sintaxis de un archivo .py usando el módulo AST.
    Devuelve un tuple: (errores_criticos, advertencias)
    """
    errores = 0
    warnings = 0
...
def ejecutar_inspeccion_proyecto(ruta_proyecto: str = None) -> str:
    """
    Escanea las rutas del proyecto buscando errores/warnings y despliega la telemetría gráfica.
    """
