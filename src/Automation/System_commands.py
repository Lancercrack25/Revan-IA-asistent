...
# Nota: crear/abrir carpeta viven en src.Services.os_service (es la implementación
# real que usa Ollama_client.py), file_actions.py quedó obsoleto y fue eliminado.
